...
export const REGUA_FRONT_COMPONENT_UNIVERSAL_IDENTIFIER =
  'f1fe118a-1bf3-480c-be32-ceaee7c0b30f';
export const REGUA_PAGE_LAYOUT_TAB_UNIVERSAL_IDENTIFIER =
  'd0161547-ef84-4f6c-a374-4e92159da06d';
export const REGUA_WIDGET_UNIVERSAL_IDENTIFIER =
  '1248852a-3b62-40bf-badc-158ddea58aec';
