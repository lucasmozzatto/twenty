...
export const GUIA_VENDEDORES = [
  ...
  'Recebidos: leads que a IA entregou à pessoa no período, contados do mesmo jeito da visão Cohort: cada negócio uma vez, na primeira vez que chegou; quem voltou do Break não conta de novo. Em aberto: desses, os que ainda não são Ganho nem Perdido. Perdidos: perderam no período, tendo passado por negociação, e continuam em Perdido. Por isso Recebidos − Ganhos − Perdidos não dá Em aberto.',
