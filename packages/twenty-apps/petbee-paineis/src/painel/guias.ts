...
export const GUIA_VENDEDORES = [
  ...
  'Recebidos: leads que chegaram na pessoa no período, contados do mesmo jeito da visão Cohort: cada negócio uma vez, na primeira vez que entrou em negociação; quem voltou do Break não conta de novo. Venda contada cujo card pulou a etapa de negociação também entra, no dia da venda. Em aberto: desses, os que ainda não são Ganho nem Perdido. Perdidos: perderam no período pela data de fechamento, estão em Perdido hoje e passaram por negociação em alguma data; lead descartado ainda na qualificação não entra, porque nenhum vendedor chegou a trabalhar nele. Se o vendedor recuperar um perdido e vender, ele sai desta coluna e entra em Ganhos. Por isso Recebidos − Ganhos − Perdidos não dá Em aberto.',
  'Ganhos e Perdidos saem da data de fechamento do card e seguem o período inteiro. Recebidos e Em aberto leem o histórico de etapas e contam a partir de 01/09/2026.',
  ...
  '"Semana a semana" é fixo: mostra sempre as últimas 24 semanas comerciais (quarta a terça) e não obedece ao filtro de período. Começa em 01/09/2026 e ganha uma linha nova a cada quarta. Serve para ver a evolução sem ficar trocando o filtro; a semana em andamento ainda vai mexer.',
  'No fim da visão, "De onde saem as perdas" mostra de qual etapa cada lead saiu para Perdido, por vendedor, e "Por que as perdas acontecem" mostra o motivo na mesma grade, com botões para ver o time ou uma pessoa. As duas primeiras colunas, em itálico, são descarte antes de o lead chegar num vendedor. As duas tabelas contam as perdas do período pela data de fechamento, a mesma régua da coluna Perdidos. "Sem registro" é perda sem a mudança de etapa gravada, herança da migração do CRM. Clique em qualquer número das duas tabelas para ver os negócios daquela célula, com link para o card e para a conversa no WhatsApp.',
...
export const GUIA_ADS = [
  ...
  'Qualificados: dos leads criados no período, os que passaram por Em negociação ou Fechamento em alguma data, inclusive quem está lá hoje, ou seja, chegaram a falar com um vendedor. Serve para separar campanha que traz volume de campanha que traz conversa.',
  'Qualificados vem do histórico de etapas, que só existe a partir de 18/08/2026: em períodos anteriores a coluna sai baixa.',
  '% qualificou é qualificados sobre leads. É o número que compara a qualidade do lead que cada campanha traz, independente do volume.',
  'Os botões trocam o que fica nas linhas: Origem e Canal são campos do CRM, o resto vem da UTM que chegou com o lead.',
  'Jornada, embaixo da tabela: três quadros sobre os mesmos leads. Clique no nome de uma linha (meta, google, uma campanha) para ver só aquele tráfego; clique de novo para voltar a todos.',
  '"Até onde chegaram" conta quem chegou pelo menos até cada etapa. Quem comprou sem passar por negociação (compra direta, recompra, card levado direto para Ganho) sai da base do funil: não é perda no primeiro degrau, é venda que não usou o funil.',
  'Fechamento não é degrau: é quando o lead diz que vai fechar daqui a alguns dias, e a maior parte das vendas vai de negociação direto para Ganho. Por isso ele aparece à parte, com o destino de quem passou por lá: Ganho, Perdido ou ainda esperando.',
  '"Perda na etapa": de quem chegou na etapa, quantos foram perdidos saindo dela. Perda em Novo Lead e Em qualificação é lead que não servia (já é cliente, fora da região, número inválido); perda em Em negociação é conversa que não fechou.',
