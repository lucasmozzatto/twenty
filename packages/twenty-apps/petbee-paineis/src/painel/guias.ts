...
export const GUIA_VENDEDORES = [
  ...
  'Recebidos: leads que chegaram na pessoa no período, contados do mesmo jeito da visão Cohort: cada negócio uma vez, na primeira vez que entrou em negociação; quem voltou do Break não conta de novo. Venda contada cujo card pulou a etapa de negociação também entra, no dia da venda. Em aberto: desses, os que ainda não são Ganho nem Perdido. Perdidos: perderam no período, tendo passado por negociação, e continuam em Perdido. Por isso Recebidos − Ganhos − Perdidos não dá Em aberto.',
  'Recebidos, Em aberto e Perdidos leem o histórico e contam a partir de 01/09/2026; Ganhos seguem a data de fechamento e o período inteiro.',
