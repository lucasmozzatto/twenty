...
export const GUIA_ADS = [
  ...
  '"Até onde chegaram" conta quem chegou pelo menos até cada etapa. Quem comprou sem passar por negociação (compra direta, recompra, card levado direto para Ganho) fica numa linha à parte, senão o funil mostraria mais vendas do que gente que conversou.',
  'Fechamento é pouco usado: a maior parte das vendas vai de Em negociação direto para Ganho. Por isso a linha Fechamento conta também quem pulou direto para Ganho.',
