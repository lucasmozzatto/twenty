// Moldura dos quadros: cartão, número grande e título de seção. Iguais aos do
// painéis, sem o rodapé de comparação.
...
export const Titulo = ({
  ...
  >
    <div style={{ fontSize: '15px', fontWeight: 700, color: tema.texto }}>
      {texto}
    </div>
    <div style={{ fontSize: '12px', color: tema.suave, marginTop: '2px' }}>
      {nota}
    </div>
  </div>
);
